        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorTheme = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageReference = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    TemplateId = table.Column<int>(type: "int", nullable: false),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    IsSkillsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsProjectsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsExperienceEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsEducationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsCertificatesEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsServicesEnabled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_Portfolios_PortfolioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactItems_Portfolios_PortfolioId",
                        column: x => x.PortfolioId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_PortfolioId",
                table: "Certificates",
                column: "PortfolioId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactItems_PortfolioId",
                table: "ContactItems",
                column: "PortfolioId");
